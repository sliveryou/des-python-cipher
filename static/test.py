...
class Cipher(Frame):
    def __init__(self, master):
        ...
        self.lab1 = Label(frame, text="")
        self.lab1.grid(row=0, column=0, sticky=W)

        self.ent1 = Entry(frame)
        self.ent1.grid(row=0, column=1, sticky=W)

        self.lab2 = Label(frame, text="")
        ...
        self.button1 = Button(frame, text="", command=self.encrypt)
        ...
        self.button2 = Button(frame, text="", command=self.decrypt)
